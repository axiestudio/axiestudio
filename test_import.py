#!/usr/bin/env python3
"""
Quick test to verify timezone import works in main branch (English app).
"""
...
try:
    ...
    print("✅ SUCCESS: Timezone utilities imported successfully in main branch (English app)")
    ...
    print(f"❌ FAILED: Import error in main branch: {e}")
    sys.exit(1)
except Exception as e:
    print(f"❌ FAILED: Unexpected error: {e}")
    sys.exit(1)

print("🎉 Main branch (English app) timezone utilities are working correctly!")
