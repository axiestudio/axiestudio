    ...
    inputs = [
        *LCModelComponent._base_inputs,
        ...
        SecretStrInput(
            ...
            info="som du kan få från https://cloud.baidu.com/product/wenxinworkshop",
        ),
        SecretStrInput(
            name="qianfan_sk",
        ...
        FloatInput(
            name="top_p",
            display_name="Top P",
            info="Modellparametrar, stöds endast i ERNIE-Bot och ERNIE-Bot-turbo",
            value=0.8,
            advanced=True,
        ),
        FloatInput(
        ...
        FloatInput(
            name="penalty_score",
            display_name="Straffpoäng",
            info="Modellparametrar, stöds endast i ERNIE-Bot och ERNIE-Bot-turbo",
            value=1.0,
            advanced=True,
        ),
        MessageTextInput(
            name="endpoint", display_name="Slutpunkt", info="Slutpunkt för Qianfan LLM, krävs om anpassad modell används."
        ),
    ]
