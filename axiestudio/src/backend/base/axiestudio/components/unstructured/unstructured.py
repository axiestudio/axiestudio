...
class UnstructuredComponent(BaseFileComponent):
    ...
    inputs = [
        *BaseFileComponent._base_inputs,
        SecretStrInput(
            name="api_key",
            display_name="Unstructured.io Serverlös API-nyckel",
            required=True,
            info="Unstructured API-nyckel. Skapa på: https://app.unstructured.io/",
        ),
        MessageTextInput(
            name="api_url",
        ...
        DropdownInput(
            ...
            display_name="Delningsstrategi",
            info="Delningsstrategi att använda, se https://docs.unstructured.io/api-reference/api-services/chunking",
        ...
        NestedDictInput(
            ...
            display_name="Ytterligare argument",
            required=False,
            info=(
                "Valfri ordbok med ytterligare argument till Loader. "
                "Se https://docs.unstructured.io/api-reference/api-services/api-parameters för mer information."
            ),
        ),
    ]
