...
class GoogleGenerativeAIEmbeddingsComponent(Component):
    ...
    description = (
        "Anslut till Googles generativa AI-inbäddningstjänst med GoogleGenerativeAIEmbeddings-klassen, "
        "som finns i langchain-google-genai-paketet."
    )
    ...
    inputs = [
        ...
        MessageTextInput(name="model_name", display_name="Modellnamn", value="models/text-embedding-004"),
    ]
                ...
                *,
                ...
                for batch in GoogleGenerativeAIEmbeddings._prepare_batches(texts, batch_size):
                    ...
                    try:
                        ...
                        msg = f"Fel vid inbäddning av innehåll: {e}"
