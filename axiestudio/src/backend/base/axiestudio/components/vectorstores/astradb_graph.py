...
class AstraDBGraphVectorStoreComponent(LCVectorStoreComponent):
    display_name: str = "Astra DB Graf"
    description: str = "Implementation av Graf Vektorlager med Astra DB"
    name = "AstraDBGraph"
    icon: str = "AstraDB"
    ...
    inputs = [
        ...
        SecretStrInput(
            name="api_endpoint",
            display_name="Databas" if os.getenv("ASTRA_ENHANCED", "false").lower() == "true" else "API-slutpunkt",
        ...
        StrInput(
            ...
            display_name="Metadata inkommande länkar nyckel",
            info="Metadatanyckel som används för inkommande länkar.",
            advanced=True,
        ),
        *LCVectorStoreComponent.inputs,
        ...
        HandleInput(
            ...
            info="Tillåter en inbäddningsmodellkonfiguration.",
        ),
        DropdownInput(
            name="metric",
            display_name="Mått",
            info="Valfritt avståndsmått för vektorjämförelser i vektorlagret.",
        ...
        IntInput(
            ...
            info="Valfritt antal data att bearbeta i en enda batch.",
            advanced=True,
        ),
        IntInput(
