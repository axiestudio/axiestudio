...
from axi.inputs.inputs import SecretStrInput, StrInput
...
class HomeAssistantControl(LCToolComponent):
    ...
    # --- Input fields for AxieStudio UI (token, URL) ---
    inputs = [
        SecretStrInput(
            name="ha_token",
    ...
    def run_model(self) -> Data:
        """Used when the 'Run' button is clicked in AxieStudio.
    ...
    def _make_data_response(self, result: dict[str, Any] | str) -> Data:
        """Returns a response in the AxieStudio Data format."""
