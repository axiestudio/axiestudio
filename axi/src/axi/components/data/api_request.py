...
from axi.base.curl.parse import parse_context
from axi.custom.custom_component.component import Component
from axi.inputs.inputs import TabInput
from axi.io import (
    BoolInput,
    DataInput,
    DropdownInput,
...
from axi.utils.component_utils import set_current_fields, set_field_advanced, set_field_display
...
class APIRequestComponent(Component):
    ...
    inputs = [
        ...
        TableInput(
            ...
            value=[{"key": "User-Agent", "value": "AxieStudio/1.0"}],
            advanced=True,
            input_types=["Data"],
            real_time_refresh=True,
        ),
