...
from axi.inputs import DataInput, DropdownInput, MessageInput, MultilineInput, SecretStrInput, SliderInput
...
class TwelveLabsPegasus(Component):
    ...
    documentation = "https://github.com/twelvelabs-io/twelvelabs-developer-experience/blob/main/integrations/AxieStudio/TWELVE_LABS_COMPONENTS_README.md"
