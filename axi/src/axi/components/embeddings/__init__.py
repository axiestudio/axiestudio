...
if TYPE_CHECKING:
    from axi.components.embeddings.similarity import EmbeddingSimilarityComponent
    from axi.components.embeddings.text_embedder import TextEmbedderComponent
