...
from axi.base.data import BaseFileComponent
from axi.base.data.docling_utils import _serialize_pydantic_model, docling_worker
from axi.inputs import BoolInput, DropdownInput, HandleInput, StrInput
from axi.schema import Data
...
class DoclingInlineComponent(BaseFileComponent):
    ...
    def process_files(self, file_list: list[BaseFileComponent.BaseFile]) -> list[BaseFileComponent.BaseFile]:
        try:
            ...
            msg = (
                "Docling is an optional dependency. Install with `uv pip install 'AxieStudio[docling]'` or refer to the "
