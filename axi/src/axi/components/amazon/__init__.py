...
if TYPE_CHECKING:
    from axi.components.amazon.amazon_bedrock_embedding import AmazonBedrockEmbeddingsComponent
    from axi.components.amazon.amazon_bedrock_model import AmazonBedrockComponent
    from axi.components.amazon.s3_bucket_uploader import S3BucketUploaderComponent
