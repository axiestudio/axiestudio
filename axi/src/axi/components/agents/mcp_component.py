...
from axi.base.agents.utils import maybe_unflatten_dict, safe_cache_get, safe_cache_set
from axi.base.mcp.util import MCPSseClient, MCPStdioClient, create_input_schema_from_json_schema, update_tools
from axi.custom.custom_component.component_with_cache import ComponentWithCache
from axi.inputs.inputs import InputTypes  # noqa: TC001
from axi.io import DropdownInput, McpInput, MessageTextInput, Output
from axi.io.schema import flatten_schema, schema_to_AXIESTUDIO_inputs
from axi.log.logger import logger
from axi.schema.dataframe import DataFrame
from axi.schema.message import Message
from axi.services.deps import get_settings_service, get_storage_service, session_scope
...
class MCPToolsComponent(ComponentWithCache):
    ...
    async def update_tool_list(self, mcp_server_value=None):
        ...
        try:
            try:
                ...
                msg = (
                    "AxieStudio MCP server functionality is not available. "
                    "This feature requires the full AxieStudio installation."
                )
    ...
    async def build_output(self) -> DataFrame:
        ...
        try:
            ...
            if self.tool != "":
                # Set session context for persistent MCP sessions using AxieStudio session ID
    ...
    def _get_session_context(self) -> str | None:
        """Get the AxieStudio session ID for MCP session caching."""
