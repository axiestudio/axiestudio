...
from axi.base.vectorstores.model import LCVectorStoreComponent, check_cached_vector_store
from axi.base.vectorstores.utils import chroma_collection_to_data
from axi.inputs.inputs import MultilineInput
from axi.io import BoolInput, DropdownInput, HandleInput, IntInput, MessageTextInput, TabInput
...
class LocalDBComponent(LCVectorStoreComponent):
    ...
    def get_default_persist_dir(self) -> str:
        ...
        from axi.services.cache.utils import CACHE_DIR
