...
from axi.helpers.data import data_to_text
from axi.inputs.inputs import DropdownInput, HandleInput, IntInput, MessageTextInput, MultilineInput, TabInput
from axi.memory import aget_messages, astore_message
...
from axi.utils.component_utils import set_current_fields, set_field_display
from axi.utils.constants import MESSAGE_SENDER_AI, MESSAGE_SENDER_NAME_AI, MESSAGE_SENDER_USER


class MemoryComponent(Component):
    display_name = "Message History"
    description = "Stores or retrieves stored chat messages from AxieStudio tables or an external memory."
    ...
    inputs = [
        ...
        HandleInput(
            ...
            input_types=["Memory"],
            info="Retrieve messages from an external memory. If empty, it will use the AxieStudio tables.",
            advanced=True,
        ),
        DropdownInput(
            name="sender_type",
