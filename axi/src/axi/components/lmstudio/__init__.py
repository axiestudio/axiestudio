...
if TYPE_CHECKING:
    from axi.components.lmstudio.lmstudioembeddings import LMStudioEmbeddingsComponent
    from axi.components.lmstudio.lmstudiomodel import LMStudioModelComponent
