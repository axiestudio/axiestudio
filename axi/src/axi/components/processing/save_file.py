...
from axi.io import DropdownInput, HandleInput, StrInput
from axi.schema import Data, DataFrame, Message
from axi.services.deps import get_settings_service, get_storage_service
...
class SaveToFileComponent(Component):
    ...
    async def _upload_file(self, file_path: Path) -> None:
        ...
        try:
            ...
            msg = (
                "AxieStudio file upload functionality is not available. "
