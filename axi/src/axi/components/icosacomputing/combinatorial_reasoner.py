...
from axi.base.models.openai_constants import OPENAI_CHAT_MODEL_NAMES
from axi.custom.custom_component.component import Component
from axi.inputs.inputs import DropdownInput, SecretStrInput, StrInput
from axi.io import MessageTextInput, Output
...
class CombinatorialReasonerComponent(Component):
    ...
    def build_prompt(self) -> Message:
        ...
        response = requests.post(
            "https://cr-api.icosacomputing.com/cr/AxieStudio",
            json=params,
            auth=creds,
            timeout=100,
        )
