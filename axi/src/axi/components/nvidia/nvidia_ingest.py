...
from axi.inputs.inputs import BoolInput, DropdownInput, FloatInput, IntInput, MessageTextInput, SecretStrInput
...
class NvidiaIngestComponent(BaseFileComponent):
    ...
    try:
        ...
        msg = (
            ...
            "Install with `uv pip install 'AxieStudio[nv-ingest]'` "
