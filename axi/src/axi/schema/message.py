...
from axi.base.prompts.utils import dict_values_to_string
from axi.log.logger import logger
from axi.schema.content_block import ContentBlock
from axi.schema.content_types import ErrorContent
from axi.schema.data import Data
from axi.schema.image import Image, get_file_paths, is_image_file
from axi.schema.properties import Properties, Source
from axi.schema.validators import timestamp_to_str, timestamp_to_str_validator
from axi.utils.constants import MESSAGE_SENDER_AI, MESSAGE_SENDER_NAME_AI, MESSAGE_SENDER_NAME_USER, MESSAGE_SENDER_USER
from axi.utils.image import create_image_content_dict
...
class Message(Data):
    ...
    def to_dataframe(self) -> DataFrame:
        from axi.schema.dataframe import DataFrame  # Local import to avoid circular import
