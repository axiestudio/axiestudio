...
from axi.inputs.inputs import AuthInput, FileInput, InputTypes, MessageTextInput, SecretStrInput, SortableListInput
from axi.io import Output
...
from axi.schema.json_schema import create_input_schema_from_json_schema
...
class ComposioBaseComponent(Component):
    ...
    def _validate_schema_inputs(self, action_key: str) -> list[InputTypes]:
        """Convert the JSON schema for *action_key* into AxieStudio input objects."""
        ...
        try:
            ...
            # Additional safety check before calling schema_to_AXIESTUDIO_inputs
            ...
            result = schema_to_AXIESTUDIO_inputs(input_schema)
