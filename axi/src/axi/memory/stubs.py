"""Memory management functions for AXI package.

This module provides message storage and retrieval functionality adapted for AXI's
service-based architecture. It mirrors the AxieStudio.memory API but works with
AXI's Message model and service interfaces.
"""
...
from axi.services.deps import session_scope
...
async def astore_message(
    ...
    # In AXI, we use the service architecture - this is a simplified implementation
    ...
    async with session_scope() as session:
        ...
        # but maintains the same interface as AxieStudio.memory
        try:
