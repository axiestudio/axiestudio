...
from axi.inputs.validators import CoalesceBool
    ...
    def validate_value(cls, v: Any, _info):
        ...
        if not isinstance(v, list):
            msg = (
                ...
                "- A Data object (AxieStudio's internal data structure)\n"
            )
        ...
        for i, item in enumerate(v):
            if not isinstance(item, dict | Data):
                msg = (
                    ...
                    "- A Data object (AxieStudio's internal data structure for passing data between components)\n"
...
class MessageInput(StrInput, InputTraceMixin):
    ...
    def _validate_value(v: Any, _info):
        ...
        # This handles both AxieStudio and AXI Message instances
...
class MessageTextInput(StrInput, MetadataTraceMixin, InputTraceMixin, ToolModeMixin):
    """Represents a text input component for the AxieStudio system.

    This component is used to handle text inputs in the AxieStudio system.
...
from axi.template.field.base import Input  # noqa: E402
