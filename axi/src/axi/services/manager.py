"""ServiceManager extracted from AxieStudio for AXI package.

This maintains the same API and most of the functionality, but removes
AxieStudio-specific auto-discovery to break dependencies.
"""
...
if TYPE_CHECKING:
    from axi.services.base import Service
    from axi.services.factory import ServiceFactory
