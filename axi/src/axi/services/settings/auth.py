...
from axi.services.settings.constants import DEFAULT_SUPERUSER, DEFAULT_SUPERUSER_PASSWORD
from axi.services.settings.utils import read_secret_from_file, write_secret_to_file
...
class AuthSettings(BaseSettings):
    ...
    """If True, allows creation of superusers via the CLI 'AxieStudio superuser' command."""
