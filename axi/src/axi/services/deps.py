"""Service dependency functions for AXI package."""
...
from axi.services.schema import ServiceType

if TYPE_CHECKING:
    from axi.services.interfaces import (
...
def get_service(service_type: ServiceType, default=None):
    ...
    """
    from axi.services.manager import get_service_manager
    ...
    if ServiceType.SETTINGS_SERVICE not in service_manager.factories:
        from axi.services.settings.factory import SettingsServiceFactory
...
def get_shared_component_cache_service() -> CacheServiceProtocol | None:
    ...
    from axi.services.shared_component_cache.factory import SharedComponentCacheServiceFactory
...
async def session_scope():
    ...
    if db_service is None or inspect.isabstract(type(db_service)):
        from axi.services.session import NoopSession
