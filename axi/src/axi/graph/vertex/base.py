...
from axi.graph.schema import INPUT_COMPONENTS, OUTPUT_COMPONENTS, InterfaceComponentTypes, ResultData
from axi.graph.utils import UnbuiltObject, UnbuiltResult, log_transaction
from axi.graph.vertex.param_handler import ParameterHandler
from axi.interface import initialize
from axi.interface.listing import lazy_load_dict
from axi.log.logger import logger
from axi.schema.artifact import ArtifactType
from axi.schema.data import Data
from axi.schema.message import Message
from axi.schema.schema import INPUT_FIELD_NAME, OutputValue, build_output_logs
from axi.utils.schemas import ChatOutputResponse
from axi.utils.util import sync_to_async
...
if TYPE_CHECKING:
    ...
    from axi.graph.graph.base import Graph
    from axi.graph.vertex.schema import NodeData
...
class Vertex:
    ...
    async def build(
        ...
        **kwargs,
        ...
        from axi.interface.components import ensure_component_loaded
        from axi.services.deps import get_settings_service
