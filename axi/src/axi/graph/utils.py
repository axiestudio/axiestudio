...
from axi.interface.utils import extract_input_variables_from_prompt
from axi.log.logger import logger
from axi.schema.data import Data
from axi.schema.message import Message

# Database imports removed - AXI should be lightweight
from axi.services.deps import get_db_service, get_settings_service
...
async def log_transaction(
    ...
    try:
        ...
        # Log basic transaction info - concrete implementation should be in AxieStudio
...
async def log_vertex_build(
    *,
    ...
    try:
        ...
        # Log basic vertex build info - concrete implementation should be in AxieStudio
...
def has_chat_output(vertices: dict[Vertex, int]):
    from axi.graph.schema import InterfaceComponentTypes
