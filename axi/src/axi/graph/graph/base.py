...
from axi.exceptions.component import ComponentBuildError
from axi.graph.edge.base import CycleEdge, Edge
from axi.graph.graph.constants import Finish, lazy_load_vertex_dict
from axi.graph.graph.runnable_vertices_manager import RunnableVerticesManager
from axi.graph.graph.schema import GraphData, GraphDump, StartConfigDict, VertexBuildResult
from axi.graph.graph.state_model import create_state_model_from_graph
from axi.graph.graph.utils import (
...
from axi.graph.schema import InterfaceComponentTypes, RunOutputs
from axi.graph.utils import log_vertex_build
from axi.graph.vertex.base import Vertex, VertexStates
from axi.graph.vertex.schema import NodeData, NodeTypeEnum
from axi.graph.vertex.vertex_types import ComponentVertex, InterfaceVertex, StateVertex
from axi.log.logger import LogConfig, configure, logger
from axi.schema.dotdict import dotdict
from axi.schema.schema import INPUT_FIELD_NAME, InputType, OutputValue
from axi.services.cache.utils import CacheMiss
from axi.services.deps import get_chat_service, get_tracing_service
from axi.utils.async_helpers import run_until_complete

if TYPE_CHECKING:
    from collections.abc import Callable, Generator, Iterable
    from typing import Any

    from axi.custom.custom_component.component import Component
    from axi.events.event_manager import EventManager
    from axi.graph.edge.schema import EdgeData
    from axi.graph.schema import ResultData
    from axi.schema.schema import InputValueRequest
    from axi.services.chat.schema import GetCache, SetCache
    from axi.services.tracing.service import TracingService
...
class Graph:
    ...
    async def _log_vertex_build_from_exception(self, vertex_id: str, result: Exception) -> None:
        ...
        if isinstance(result, ComponentBuildError):
            ...
            from axi.utils.exceptions import format_exception_message
