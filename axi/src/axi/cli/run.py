...
from axi.cli.script_loader import (
...
async def run(
    ...
    *,
    ...
    """Execute an AxieStudio graph script or JSON flow and return the result.

    This command analyzes and executes either a Python script containing an AxieStudio graph,
    ...
    try:
        ...
        if file_extension == ".py":
            ...
            from axi.load import aload_flow_from_json
