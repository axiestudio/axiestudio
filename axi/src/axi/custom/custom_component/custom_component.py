...
from axi.custom.custom_component.base_component import BaseComponent
from axi.helpers.flow import list_flows, load_flow, run_flow
from axi.log.logger import logger
from axi.schema.data import Data
from axi.services.deps import get_storage_service, get_variable_service, session_scope
from axi.services.storage.service import StorageService
from axi.template.utils import update_frontend_node_with_template_values
from axi.type_extraction import post_process_type
...
if TYPE_CHECKING:
    ...
    from axi.schema.schema import OutputValue
    from axi.services.storage.service import StorageService
    from axi.services.tracing.service import TracingService


class CustomComponent(BaseComponent):
    """Represents a custom component in AxieStudio.
    ...
    def tracing_service(self):
        ...
        if self._tracing_service is None:
            from axi.services.deps import get_tracing_service
