...
from axi.base.tools.constants import (
    TOOL_OUTPUT_DISPLAY_NAME,
    TOOL_OUTPUT_NAME,
    TOOLS_METADATA_INFO,
    TOOLS_METADATA_INPUT_NAME,
)
from axi.custom.tree_visitor import RequiredInputsVisitor
from axi.exceptions.component import StreamingError
from axi.field_typing import Tool  # noqa: TC001

# Lazy import to avoid circular dependency
# from axi.graph.state.model import create_state_model
# Lazy import to avoid circular dependency
# from axi.graph.utils import has_chat_output
from axi.helpers.custom import format_type
from axi.memory import astore_message, aupdate_messages, delete_message
from axi.schema.artifact import get_artifact_type, post_process_raw
from axi.schema.data import Data
from axi.schema.log import Log
from axi.schema.message import ErrorMessage, Message
from axi.schema.properties import Source
from axi.template.field.base import UNDEFINED, Input, Output
from axi.template.frontend_node.custom_components import ComponentFrontendNode
from axi.utils.async_helpers import run_until_complete
from axi.utils.util import find_closest_match
...
if TYPE_CHECKING:
    ...
    from axi.base.tools.component_tool import ComponentToolkit
    from axi.events.event_manager import EventManager
    from axi.graph.edge.schema import EdgeData
    from axi.graph.vertex.base import Vertex
    from axi.inputs.inputs import InputTypes
    from axi.schema.dataframe import DataFrame
    from axi.schema.log import LoggableType
...
class Component(CustomComponent):
    ...
    async def _build_tools_metadata_input(self):
        try:
            from axi.inputs.inputs import ToolsInput
        except ImportError as e:
            msg = "Failed to import ToolsInput from axi.inputs.inputs"
    ...
    def _ensure_message_required_fields(self, message: Message) -> None:
        ...
        """
        from axi.utils.constants import MESSAGE_SENDER_AI, MESSAGE_SENDER_NAME_AI
