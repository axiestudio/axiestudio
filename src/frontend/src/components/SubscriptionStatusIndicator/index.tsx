  ...
  const getStatusInfo = () => {
    ...
    switch (status) {
      ...
      case 'trial':
        ...
        return {
          icon: Clock,
          label: `Trial (${subscriptionStatus.trial_days_left || 0} days left)`,
          color: 'bg-blue-500',
        ...
        <Tooltip>
          ...
          <TooltipContent>
            <div className="text-sm">
              ...
              {showLastUpdated && (
                <p><strong>Last updated:</strong> {formatLastUpdated()}</p>
              )}
              {subscriptionStatus?.subscription_id && (
                <p><strong>Subscription ID:</strong> {subscriptionStatus.subscription_id.slice(-8)}</p>
              )}
            </div>
          </TooltipContent>
        </Tooltip>
