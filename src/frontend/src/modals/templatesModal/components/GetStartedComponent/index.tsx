  ...
  const cardData: CardData[] = [
    {
      ...
      icon: "MessagesSquare",
      category: "prompting",
      flow: examples.find((example) => example.name === "Grundläggande promptning"),
    },
    {
      bgImage: vectorRag,
      ...
      icon: "Database",
      category: "RAG",
      flow: examples.find((example) => example.name === "Vektorlager RAG"),
    },
    {
      bgImage: multiAgent,
      ...
      icon: "Bot",
      category: "Agents",
      flow: examples.find((example) => example.name === "Enkel agent"),
    },
  ];
