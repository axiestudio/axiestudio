...
Bygg ett dokument om detta ämne.""",
    ...
    researcher_task_agent.set(
        ...
        backstory="Forskning har alltid varit din grej. Du kan snabbt hitta saker på webben tack vare dina färdigheter.",
        tools=[search_api_tool.build_tool],
        llm=llm.build_model,
        task_description=document_prompt_component.build_prompt,
        expected_output="Punktlistor och korta fraser om forskningsämnet.",
    )
...
Revidera detta dokument.""",
    ...
    editor_task_agent.set(
        role="Redaktör",
        goal="Du ska redigera informationen som tillhandahålls av forskaren för att göra den mer lättsmält och för att inte innehålla "
        "vilseledande information.",
        backstory="Du är redaktör för den mest välrenommerade tidskriften i världen.",
        llm=llm.build_model,
...
Bygg ett roligt blogginlägg om detta ämne.""",
    ...
    comedian_task_agent.set(
        ...
        backstory="Din formella yrkestitel är Chefkomiker. "
