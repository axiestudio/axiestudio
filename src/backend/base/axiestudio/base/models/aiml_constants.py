...
class AimlModels:
    ...
    def get_aiml_models(self):
        try:
            ...
            msg = "Misslyckades att ansluta till AI/ML API."
            raise APIConnectionError(msg) from e
        except httpx.HTTPStatusError as e:
            msg = f"AI/ML API svarade med statuskod: {e.response.status_code}"
            raise APIError(
                message=msg,
                body=None,
                request=e.request,
        ...
        try:
            ...
            msg = "Misslyckades att tolka svarsdata från AI/ML API. Formatet kan vara felaktigt."
