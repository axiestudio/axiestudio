...
def upgrade() -> None:
    ...
    try:
        ...
        print("🔧 MERGE MIGRATION: Resolving multiple heads issue...")
        ...
        print("🎉 MERGE MIGRATION COMPLETED: Multiple heads resolved!")
...
def downgrade() -> None:
    ...
    try:
        print("🔄 MERGE MIGRATION DOWNGRADE: Safely reverting changes...")
