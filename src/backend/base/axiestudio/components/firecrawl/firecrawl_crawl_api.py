...
class FirecrawlCrawlApi(Component):
    ...
    inputs = [
        ...
        StrInput(
            ...
            info="Valfri idempotens-nyckel för att säkerställa unika begäranden.",
        ),
        DataInput(
            name="crawlerOptions",
            display_name="Crawleralternativ",
            info="Crawleralternativen att skicka med begäran.",
        ),
        DataInput(
            name="scrapeOptions",
            display_name="Skrapningsalternativ",
            info="Sidalternativen att skicka med begäran.",
        ),
    ]
