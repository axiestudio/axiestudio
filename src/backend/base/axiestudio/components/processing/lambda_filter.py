...
class LambdaFilterComponent(Component):
    display_name = "Smart funktion"
    description = "Använder en LLM för att generera en funktion för filtrering eller transformering av strukturerad data."
    ...
    inputs = [
        DataInput(
            name="data",
            display_name="Data",
            info="Den strukturerade datan att filtrera eller transformera med en lambda-funktion.",
            is_list=True,
            required=True,
        ),
        HandleInput(
        ...
        MultilineInput(
            ...
            info=(
                "Naturliga språkinstruktioner för hur man filtrerar eller transformerar datan med en lambda-funktion. "
                "Exempel: Filtrera datan för att endast inkludera objekt där 'status' är 'aktiv'."
            ),
            value="Filtrera datan för att...",
            required=True,
        ),
        IntInput(
            name="sample_size",
            display_name="Sampelstorlek",
            info="För stora dataset, antal objekt att sampla från början/slutet.",
            value=1000,
            advanced=True,
        ),
        IntInput(
            name="max_size",
            display_name="Max storlek",
            info="Antal tecken för att datan ska anses vara stor.",
            value=30000,
            advanced=True,
        ),
    ]
