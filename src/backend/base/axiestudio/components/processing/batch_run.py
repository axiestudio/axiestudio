...
class BatchRunComponent(Component):
    ...
    documentation: str = "https://docs.axiestudio.se/components-processing#batch-run"
    icon = "List"
    ...
    inputs = [
        ...
        MessageTextInput(
            name="column_name",
            display_name="Kolumnnamn",
            info=(
                "Namnet på DataFrame-kolumnen att behandla som textmeddelanden. "
                "Om tomt kommer alla kolumner att formateras i TOML."
            ),
            required=False,
            advanced=False,
        ),
        MessageTextInput(
            ...
            display_name="Utmatningskolumnnamn",
            info="Namnet på kolumnen där modellens svar kommer att lagras.",
        ...
        BoolInput(
            ...
            display_name="Aktivera metadata",
            info="Om Sant, lägg till metadata till utmatnings-DataFrame.",
            value=False,
            required=False,
            advanced=True,
        ),
    ...
    outputs = [
        Output(
            display_name="LLM-resultat",
            name="batch_results",
            method="run_batch",
            info="En DataFrame med alla ursprungliga kolumner plus modellens svarskolumn.",
        ),
    ]
