...
class ConfluenceComponent(Component):
    ...
    inputs = [
        ...
        StrInput(
            ...
            required=True,
            info="Atlassian användar-e-post. Exempel: email@example.com",
        ),
        SecretStrInput(
            name="api_key",
        ...
        DropdownInput(
            ...
            required=True,
            advanced=True,
            info="Ange innehållsformat, standard är ContentFormat.STORAGE",
        ),
        IntInput(
            name="max_pages",
            display_name="Max sidor",
            required=False,
            value=1000,
            advanced=True,
            info="Maximalt antal sidor att hämta totalt, standard 1000",
        ),
    ]
