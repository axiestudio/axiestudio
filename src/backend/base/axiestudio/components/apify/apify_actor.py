...
class ApifyActorsComponent(Component):
    ...
    inputs = [
        ...
        MultilineInput(
            name="run_input",
            display_name="Körningsindata",
            info=(
                'JSON-indata för aktörkörningen. Till exempel för "apify/website-content-crawler"-aktören: '
        ...
        MultilineInput(
            ...
            info=(
                ...
                "Exempelindata: 'text, metadata.title'. "
                "Exempelutdata: {'text': 'page content here', 'metadata_title': 'page title here'}. "
        ...
        BoolInput(
            ...
            display_name="Platta ut utdata",
            info=(
                "Utdatasetet kommer att konverteras från ett nästlat format till en platt struktur. "
    ...
    outputs = [
        Output(display_name="Utdata", name="output", type_=list[Data], method="run_model"),
        Output(display_name="Verktyg", name="tool", type_=Tool, method="build_tool"),
    ]
