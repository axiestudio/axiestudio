...
class CleanlabEvaluator(Component):
    ...
    inputs = [
        ...
        DropdownInput(
            name="quality_preset",
            display_name="Kvalitetsförinställning",
            options=["base", "low", "medium", "high", "best"],
            value="medium",
            info="Detta bestämmer noggrannheten, latensen och kostnaden för utvärderingen. Högre kvalitet är generellt "
            "långsammare men mer noggrann.",
            required=True,
            advanced=True,
        ),
    ]
    ...
    outputs = [
        ...
        Output(display_name="Förtroendepoäng", name="score", method="get_score", types=["number"], group_outputs=True),
        Output(
